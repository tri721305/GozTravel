                      ...
                      <div className="tp-gallery-item col-md-3 col-sm-6">
                        <div className="tp-gallery-item-img">
                          <a href="#" data-effect="mfp-zoom-in">
                            <img src={publicUrl+"assets/img/tour-details/2.png"} alt="image" style={{height: '245px'}}/>
                          </a>
                        </div>
                      </div>
                      {/* gallery-item */}
                    ...
                    <div className="row">
                      <div className="col-xl-3 col-lg-4">
                        <div className="details">
                          <p className="location mb-0"><i className="fa fa-map-marker" />VietNam</p>
                      ...
                      <div className="col-xl-9 col-lg-8">
                        <div className="book-list-warp">
                          <p className="book-list-content">Soạn đồ và đi thoi các bạn.</p>
                          <div className="tp-price-meta">
                            <p>Price</p>
                            <h2>1.775.000 vnd <small></small></h2>
                          </div>
                        </div>
                ...
                <div className="row">
                  <div className="col-lg-8">
                    <div className="tour-details-wrap">
                      ...
                      <p>Hoa dã quỳ cuối mùa
Cứ nghĩ đến Đà Lạt vào tháng 12, thì chẳng được ngắm hoa dã quỳ. Nhưng ngày đầu tiên đến Đà Lạt, đi con xe cúp vòng vòng cánh đồng rau ở đường lên đồi Thiên Phúc Đức lại gặp bụi hoa dã quỳ này.
📍Các bạn đến Đà Lạt vào dịp cuối năm như mình, muốn chụp ảnh hoa dã quỳ có thể đến các tuyến đường đi đồi Thiên Phúc Đức, đồi Đa Phú hoặc đường đi Cầu Đất nhé.</p>
                          ...
                          <div className="col-lg-4 col-md-4">
                            <div className="single-blog">
                              ...
                              <div className="single-blog-details">
                                ...
                                <p className="content">Bước xuống xe là cảm giác không lẫn vào đâu được, không khí se se lạnh....</p>
                          ...
                          <div className="col-lg-4 col-md-4">
                            <div className="single-blog">
                              ...
                              <div className="single-blog-details">
                                ...
                                <p className="content">Ngày thứ hai, nhóm tụi mình đã ghé thăm cafe nhà gỗ, ......</p>
                                <a className="btn-read-more" href="#"><span>Show More<i className="la la-arrow-right" /></span></a>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-4">
                            <div className="single-blog single-blog-after-none">
                              ...
                              <div className="single-blog-details">
                                ...
                                <p className="content">Ngày cuối cùng nhóm tụi mình đã quyết định đi ngắm bình minh, săn mây ở ....</p>
                                <a className="btn-read-more" href="#"><span>Show More<i className="la la-arrow-right" /></span></a>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="widget tour-list-widget">
                        <div className="widget-tour-list-meta">
                          ...
                          <div className="text-lg-center text-left">
                            <a className="btn btn-yellow" href="#">Find a Trip <i className="fa fa-paper-plane" /></a>
                          </div>
                        </div>
                      </div>
